      ...
      <nav className="w-full h-10 flex justify-center items-center m-0 p-0  ">
        <div className="container w-full h-full  flex ">
          <ul
            className={`${
              isOpen
                ? "w-full h-auto bg-white text-black flex flex-col md:w-72 border-2 absolute top-34 left-0 "
                : "hidden lg:flex Links w-full  flex-1 h-auto p-0 m-0 list-none  font-bold font-mono text-[15px] uppercas tracking-widest"
            }`}
          >
            <h2
              className={`${
                isOpen
                  ? " w-full h-12 flex justify-center items-center mt-3 mb-4 uppercase text-3xl text-black "
                  : "hidden"
              }`}
            >
              Menu
            ...
            <li
              className={`${
                isOpen
                  ? "w-full hover:bg-gray-500 transition-all justify-start border-b-2 py-4"
                  : "hover:none"
              } w-auto  flex justify-center items-center text-gray-700 py-1 px-2`}
            >
              <Link
            ...
            <li
              className={`${
                isOpen
                  ? "w-full hover:bg-gray-500 transition-all justify-start border-b-2 py-4"
                  : "hover:none"
              } w-auto flex justify-center items-center text-gray-700 py-4 px-2`}
            >
              <Link
                className="w-full h-full  flex justify-center items-center uppercase"
                href="/massage-us"
          ...
          <div className="search_icons-cart lg:flex justify-end items-center hidden font-mono">
